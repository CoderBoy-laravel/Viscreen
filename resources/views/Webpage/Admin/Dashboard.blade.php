<x-app-layout>
    <div class="mt-5 md:flex items-center justify-between">
        <div class="flex bg-gradient-to-r items-center from-teal-500 to-emerald-800 px-5 py-3 md:w-1/4 rounded-md shadow-md">
        ...
        <div class="flex bg-gradient-to-r items-center from-blue-500 to-indigo-500 px-5 py-3 md:w-1/4 rounded-md shadow-md">
